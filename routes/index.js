...
获取参数
 */
router.get('/request/Parameter/:id', (req, res, next) => {
    const query = req.query;
    const params = req.params;
    const json = req.json;
    res.json({code: 0, msg: 'success', data: {query: query, params: params, json: json}});
});


router.post('/request/Parameter/:id', (req, res, next) => {
    const json = req.json;
    res.json({code: 0, msg: 'success', data: {json: json}});
});
